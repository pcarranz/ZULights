 ...
 * Back-wheel LED bike light system.
...
__interrupt void Port_1 (void) {
	newTime = TAR >> 2;    //Store a reduced timer A value
	currentLED = 6;        //Helps maintain pattern
	TAR = 0;               //Reset timer A
...
void nextLEDOn() {
	...
	if (++currentLED == 12)    //Loop through LEDS and wrap around
		currentLED = 3;
